...
- **[adding-a-cluster](adding-a-cluster.md)** — the n-cluster onboarding path: cluster tree anatomy, per-app opt-in overlays, CI guardrails, current cluster roles (Talos = prod, SNO = AI lab).
